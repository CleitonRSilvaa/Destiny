...
const url = "http://localhost:5000/api/delsoftx/Login?matricula=1800&cpf=2560";

// Usando a API fetch para fazer uma chamada GET
fetch(url, {
    method: 'GET', // especifica o método da requisição
    headers: {
        'Accept': '*/*',
...
.then(response => response.json()) // presumindo que a resposta seja um JSON
.then(data => {
    console.log(data); // aqui você tem o resultado da chamada
})
.catch(error => {
